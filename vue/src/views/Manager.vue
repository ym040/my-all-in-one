      ...
      <div class="manager-main-left">
        <el-menu router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="info">
            ...
            <el-menu-item index="/resume" v-if="user.role === 'ADMIN'">简历信息</el-menu-item>
            <el-menu-item index="/MyResume" v-if="user.role === 'STUDENT'">我的简历</el-menu-item>
          </el-submenu>
