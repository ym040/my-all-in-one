  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="teacherName" label="辅导员" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="班级信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
