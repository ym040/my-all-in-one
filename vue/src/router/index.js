...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'teacherPerson', name: 'TeacherPerson', meta: { name: '教师个人信息' }, component: () => import('../views/manager/TeacherPerson') },
      { path: 'studentPerson', name: 'StudentPerson', meta: { name: '学生个人信息' }, component: () => import('../views/manager/StudentPerson') },
      { path: 'enterprisePerson', name: 'EnterprisePerson', meta: { name: '企业个人信息' }, component: () => import('../views/manager/EnterprisePerson') },
      ...
      { path: 'myResume', name: 'MyResume', meta: { name: '我的简历' }, component: () => import('../views/manager/MyResume.vue')},
